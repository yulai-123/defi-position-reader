...
![Uniswap V3 资产模型图](../diagrams/uniswap-v3-asset-model.png)
...
![Uniswap V3 Position 读取流程图](../diagrams/uniswap-v3-position-flow.png)
...
下面用 Base 上的地址做示例。这个地址持有 Uniswap V3 LP NFT，可以用来验证 metadata 同步、NFT 枚举、本金和手续费解析。
