...
![Compound V3 Comet 资产模型图](../diagrams/compound-v3-comet-model.svg)
...
![Compound V3 Position 计算链路](../diagrams/compound-v3-position-calculation.svg)
